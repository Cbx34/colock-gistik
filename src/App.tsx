...
export default function App() {
  ...
  const connectApifyAndRunShopifyTest = async () => {
    ...
    try {
      ...
      setApifyMessages([connectionResult.message, connectionResult.tokenSource ? `Token vérifié depuis : ${connectionResult.tokenSource}` : ''].filter(Boolean));
      if (connectionResult.status !== 'connected') return;
